...
from . import node_def_pb2 as tensorboardX_dot_src_dot_node__def__pb2
from . import versions_pb2 as tensorboardX_dot_src_dot_versions__pb2
...
_GRAPHDEF.fields_by_name[
    'node'].message_type = tensorboardX_dot_src_dot_node__def__pb2._NODEDEF
_GRAPHDEF.fields_by_name[
    'versions'].message_type = tensorboardX_dot_src_dot_versions__pb2._VERSIONDEF
...
_GRAPHDEF.fields_by_name['version']._options = _descriptor._ParseOptions(
