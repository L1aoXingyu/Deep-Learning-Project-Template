...
from . import resource_handle_pb2 as tensorboardX_dot_src_dot_resource__handle__pb2
...
_TENSORPROTO.fields_by_name[
    'dtype'].enum_type = tensorboardX_dot_src_dot_types__pb2._DATATYPE
_TENSORPROTO.fields_by_name[
    'tensor_shape'].message_type = tensorboardX_dot_src_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_TENSORPROTO.fields_by_name[
    'resource_handle_val'].message_type = tensorboardX_dot_src_dot_resource__handle__pb2._RESOURCEHANDLEPROTO
...
_TENSORPROTO.fields_by_name[
    'scomplex_val']._options = _descriptor._ParseOptions(
        descriptor_pb2.FieldOptions(), _b('\020\001'))
...
_TENSORPROTO.fields_by_name[
    'dcomplex_val']._options = _descriptor._ParseOptions(
        descriptor_pb2.FieldOptions(), _b('\020\001'))
